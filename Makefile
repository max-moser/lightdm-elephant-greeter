...
install: elephant-greeter.conf
	...
	install -D -m 644 -t $(PKG_PREFIX)$(INSTALL_PATH)/share/lightdm/greeters lightdm-elephant-greeter.desktop lightdm-elephant-greeter-x11.desktop
...
uninstall:
	...
	rm $(INSTALL_PATH)/share/lightdm/greeters/lightdm-elephant-greeter.desktop
	rm $(INSTALL_PATH)/share/lightdm/greeters/lightdm-elephant-greeter-x11.desktop
